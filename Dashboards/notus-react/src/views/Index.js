  ...
  return (
    <>
        ...
        <div className="container mx-auto items-center flex flex-wrap justify-center align-center">
          <div className="w-1/2 mx-4 px-4 align-center">
            <div className="pt-32 sm:pt-0 text-center">
              <h2 className="font-semibold text-4xl text-main">
              YOU ONLY NEED ONE LINK.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-400">
              Unleash the power to share more content than ever before. Link your Facebook, Instagram, personal website, merch store, or any project you may be working on all in one place. You’ll never have to decide which URL to put in your bio again.
              </p>
              <div className="mt-12">
                <a
                  href="https://www.creative-tim.com/learning-lab/tailwind/react/overview/notus?ref=nr-index"
                  target="_blank"
                  className="get-started text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-main active:bg-lightBlue-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
                >
                  Get started
                </a>
              </div>
      ...
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px justify-center bg-black">
        ...
        <img
          className="absolute top-0 b-auto pt-16 sm:w-6/12 -mt-48 sm:mt-0 w-10/12 max-h-860px"
          src={require("assets/img/kassmasse.jpg").default}
          alt="..."
        />
      </section>
      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                <img
                  alt="..."
                  src={require("assets/img/first.jpeg").default}
        ...
        <div className="container mx-auto px-4 pb-32 pt-48">
          ...
          <div className="w-full md:w-6/12 mr-auto px-4 pt-24 md:pt-0">
              <img
                alt="..."
                className="max-w-full rounded-lg shadow-xl w-10/12"
                style={{
                  transform:
          ...
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto mt-32">
              ...
              <img
                ...
                src={require("assets/img/second.png").default}
              />
              </div>
            </div>
          </div>
