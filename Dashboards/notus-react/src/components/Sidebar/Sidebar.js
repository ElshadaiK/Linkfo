...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-indigo flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          {/* Brand */}
          <Link
            className="md:block text-left md:pb-2 gold mr-0 inline-block whitespace-nowrap text-lg uppercase font-bold p-4 px-0"
            to="/"
          >
            LINKFRO
          </Link>
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                <Link
                  className={
                    ...
                    (window.location.href.indexOf("/admin/dashboard") !== -1
                      ? "gold hover:text-lightBlue-600"
                      : "text-blueGray-400 hover:text-blueGray-500")
                  }
                  to="/admin/dashboard"
                >
                  <i
              ...
              <li className="items-center">
                <Link
                  className={
                    "text-xs uppercase py-3 font-bold block " +
                    (window.location.href.indexOf("/admin/createlinks") !== -1
                      ? "gold hover:text-lightBlue-600"
                      : "text-blueGray-400 hover:text-blueGray-500")
                  }
                  to="/admin/createlinks"
                >
                  <i
                    className={
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              <li className="items-center">
                <Link
                  className="text-blueGray-400 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                  to="/auth/login"
                >
